...
if fillData:
    ...
    if(args.collType == "ALL"):
        ...
        updateDB.UpdateDayFill(fillData, SummaryFields, "PROTONS", args)
        print "="*10 + "PROTONS_PB PROTONS_PB PROTONS_PB" + "="*10
        updateDB.UpdateDayFill(fillData, SummaryFields, "PROTONS_PB", args)
        print "="*10 + "PB PB PB" + "="*30
        updateDB.UpdateDayFill(fillData, SummaryFields, "PB", args)
    else:
        updateDB.UpdateDayFill(fillData, SummaryFields, args.collType, args)
