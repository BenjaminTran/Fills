...
if fillData:
    ...
    if(args.collType == "ALL"):
        ...
        updateDB.UpdateMonthFill(fillData, SummaryFields, "PROTONS", args)
        print "="*10 + "PROTONS_PB PROTONS_PB PROTONS_PB" + "="*10
        updateDB.UpdateMonthFill(fillData, SummaryFields, "PROTONS_PB", args)
        print "="*10 + "PB PB PB" + "="*30
        updateDB.UpdateMonthFill(fillData, SummaryFields, "PB", args)
    else:
        updateDB.UpdateMonthFill(fillData, SummaryFields, args.collType, args)
